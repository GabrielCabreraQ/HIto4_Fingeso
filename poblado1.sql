...
values
	...
	('Sebastian Del Solar','sebastian.delsolar@usach.cl','1234','947563381','1988-04-28','administrador','Santiago'),
...
INSERT INTO vehiculo (marca, modelo, anio, tipo_transmision, categoria, tipo_cuerpo, combustibleac, devuelto, eliminado)
VALUES
    ('Toyota', 'Aygo', 2023, 'M', 'M', 'B', 'R', true, false),
    ('BMW', 'Mini Cooper', 2022, 'N', 'N', 'C', 'N', true, false),
    ('Ford', 'Fiesta', 2021, 'C', 'E', 'D', 'D', true, false),
    ('Volkswagen', 'Golf Variant', 2023, 'A', 'H', 'W', 'Q', true, false),
    ('Honda', 'Civic', 2020, 'B', 'C', 'V', 'H', true, false),
    ('Tesla', 'Model 3', 2023, 'D', 'D', 'L', 'I', true, false),
    ('Chevrolet', 'Malibu', 2019, 'M', 'I', 'S', 'E', true, false),
    ('Mazda', 'MX-5', 2021, 'A', 'J', 'T', 'E', true, false),
    ('Toyota', 'RAV4', 2020, 'D', 'S', 'F', 'L', true, false),
    ('Jeep', 'Wrangler', 2023, 'M', 'R', 'J', 'S', true, false),
    ('Hyundai', 'Santa Fe', 2021, 'D', 'F', 'X', 'A', true, false),
    ('Ford', 'Ranger', 2022, 'M', 'G', 'P', 'B', true, false),
    ('Audi', 'Q7', 2023, 'D', 'P', 'Q', 'F', true, false),
    ('Porsche', 'Cayenne', 2023, 'B', 'U', 'Z', 'F', true, false),
    ('Mercedes-Benz', 'S-Class', 2023, 'D', 'L', 'E', 'V', true, false),
    ('Tesla', 'Model X', 2023, 'B', 'W', 'M', 'Z', true, false),
    ('Winnebago', 'Vista', 2022, 'D', 'O', 'R', 'U', true, false),
    ('Ford', 'Transit', 2021, 'B', 'X', 'H', 'X', true, false),
    ('Suzuki', 'Celerio', 2018, 'M', 'C', 'C', 'N', true, false);
